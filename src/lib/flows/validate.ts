...
export function validateFlowForActivation(
  ...
  if (!flow.entry_node_id) {
    issues.push({
      ...
      scope: "flow",
      field: "entry_node_id",
      message: "Selecione um nó inicial antes de ativar.",
    });
  }
  ...
  if (flow.entry_node_id && !keys.has(flow.entry_node_id)) {
    issues.push({
      ...
      scope: "flow",
      field: "entry_node_id",
      message: `O nó inicial "${flow.entry_node_id}" não existe.`,
    });
  }
    ...
    for (const n of nodes) {
      if (!reached.has(n.node_key)) {
        issues.push({
          ...
          scope: "node",
          node_key: n.node_key,
          message: `O nó "${n.node_key}" não está conectado a partir do nó inicial.`,
        });
      }
    }
  }
  ...
  if (trigger_type === "keyword") {
    ...
    if (!keywords || keywords.length === 0) {
      issues.push({
        ...
        message: "Gatilhos por palavra-chave precisam de ao menos uma palavra-chave.",
      });
    } else {
      ...
      if (blanks > 0) {
        issues.push({
          ...
          scope: "trigger",
          field: "trigger_config.keywords",
          message: `${blanks} palavra${blanks === 1 ? "" : "s"}-chave vazia${blanks === 1 ? "" : "s"} - não terá${blanks === 1 ? "" : "o"} correspondência.`,
        });
      }
    }
  }
    ...
    case "start": {
      ...
      if (!cfg.next_node_key) {
        issues.push({
          ...
          field: "next_node_key",
          message: "Nó INÍCIO deve apontar para um próximo nó.",
        });
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `INÍCIO aponta para nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "send_message": {
      ...
      if (!cfg.text?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "text",
          message: "Nó ENVIAR MENSAGEM precisa de um texto.",
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: "Nó ENVIAR MENSAGEM deve apontar para um próximo nó.",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `ENVIAR MENSAGEM aponta para nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "send_media": {
      ...
      if (
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "media_type",
          message: "Nó ENVIAR MÍDIA precisa de um tipo de mídia (image, video ou document).",
        });
      }
      if (!cfg.media_url?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "media_url",
          message: "Nó ENVIAR MÍDIA precisa de um arquivo (faça upload antes de ativar).",
        });
      }
      ...
      if (cfg.caption && cfg.caption.length > INTERACTIVE_LIMITS.bodyMaxLength) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "caption",
          message: `Legenda excede ${INTERACTIVE_LIMITS.bodyMaxLength} caracteres (limite do WhatsApp).`,
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: "Nó ENVIAR MÍDIA deve apontar para um próximo nó.",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `ENVIAR MÍDIA aponta para nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "send_buttons": {
      ...
      if (!cfg.text?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "text",
          message: "Nó ENVIAR BOTÕES precisa de um texto.",
        });
      }
      ...
      if (btns.length < 1) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "buttons",
          message: "Nó ENVIAR BOTÕES precisa de pelo menos um botão.",
        });
      }
      ...
      btns.forEach((b, i) => {
        ...
        if (!b.reply_id?.trim()) {
          issues.push({
            ...
            message: `Botão ${i + 1} precisa de um reply_id.`,
          });
          ...
          issues.push({
            ...
            node_key: node.node_key,
            field: `${field}.reply_id`,
            message: `reply_id de botão duplicado "${b.reply_id}".`,
          });
        }
        ...
        if (!b.title?.trim()) {
          issues.push({
            ...
            node_key: node.node_key,
            field: `${field}.title`,
            message: `Botão ${i + 1} precisa de um título.`,
          });
          ...
          issues.push({
            ...
            node_key: node.node_key,
            field: `${field}.title`,
            message: `Título do botão ${i + 1} excede ${INTERACTIVE_LIMITS.buttonTitleMaxLength} caracteres (limite do WhatsApp).`,
          });
        }
        ...
        if (!b.next_node_key) {
          issues.push({
            ...
            message: `Botão ${i + 1} precisa de um próximo nó.`,
          });
          ...
          issues.push({
            ...
            node_key: node.node_key,
            field: `${field}.next_node_key`,
            message: `Botão ${i + 1} aponta para nó inexistente "${b.next_node_key}".`,
          });
        }
      });
      break;
    ...
    case "send_list": {
      ...
      if (!cfg.text?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "text",
          message: "Nó ENVIAR LISTA precisa de um texto.",
        });
      }
      if (!cfg.button_label?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "button_label",
          message: "Nó ENVIAR LISTA precisa do texto do botão de abertura.",
        });
      }
      ...
      if (totalRows < 1) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "sections",
          message: "Nó ENVIAR LISTA precisa de pelo menos uma linha.",
        });
      }
      if (totalRows > INTERACTIVE_LIMITS.maxListRowsTotal) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "sections",
          message: `ENVIAR LISTA permite no máximo ${INTERACTIVE_LIMITS.maxListRowsTotal} linhas no total entre seções.`,
        });
      }
      const seenIds = new Set<string>();
        ...
        rows.forEach((row, ri) => {
          ...
          if (!row.reply_id?.trim()) {
            issues.push({
              ...
              node_key: node.node_key,
              field: `${field}.reply_id`,
              message: `Linha ${ri + 1} da seção ${si + 1} precisa de um reply_id.`,
            });
          ...
          if (!row.title?.trim()) {
            issues.push({
              ...
              node_key: node.node_key,
              field: `${field}.title`,
              message: `Linha ${ri + 1} precisa de um título.`,
            });
          } else if (
            ...
            issues.push({
              ...
              node_key: node.node_key,
              field: `${field}.title`,
              message: `Título da linha ${ri + 1} excede ${INTERACTIVE_LIMITS.listRowTitleMaxLength} caracteres.`,
            });
          }
          if (
            row.description &&
            ...
            issues.push({
              ...
              message: `Descrição da linha ${ri + 1} excede ${INTERACTIVE_LIMITS.listRowDescriptionMaxLength} caracteres.`,
            });
          }
          if (!row.next_node_key) {
            issues.push({
              ...
              node_key: node.node_key,
              field: `${field}.next_node_key`,
              message: `Linha ${ri + 1} precisa de um próximo nó.`,
            });
            ...
            issues.push({
              ...
              node_key: node.node_key,
              field: `${field}.next_node_key`,
              message: `Linha ${ri + 1} aponta para nó inexistente "${row.next_node_key}".`,
            });
          }
        });
      });
    ...
    case "collect_input": {
      ...
      if (!cfg.prompt_text?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "prompt_text",
          message: "Nó COLETAR RESPOSTA precisa de uma mensagem de pergunta para o cliente.",
        });
      }
      if (!cfg.var_key?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "var_key",
          message: "Nó COLETAR RESPOSTA precisa de uma var_key para armazenar a resposta.",
        });
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "var_key",
          message: `var_key "${cfg.var_key}" deve ser alfanumérica com underscore e começar por letra ou underscore.`,
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: "Nó COLETAR RESPOSTA deve apontar para um próximo nó.",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `COLETAR RESPOSTA aponta para nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "condition": {
      ...
      if (!cfg.subject || !["var", "tag", "contact_field"].includes(cfg.subject)) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "subject",
          message: "CONDIÇÃO precisa de um subject (var / tag / contact_field).",
        });
      }
      if (!cfg.subject_key?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "subject_key",
          message: "CONDIÇÃO precisa de subject_key (nome da variável, id da etiqueta ou nome do campo).",
        });
      }
      if (
        !cfg.operator ||
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "operator",
          message: "CONDIÇÃO precisa de um operador.",
        });
      } else if (
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "value",
          message: `Operador "${cfg.operator}" normalmente espera um valor de comparação - valor vazio só combina com conteúdo vazio.`,
        });
      }
      for (const branch of ["true_next", "false_next"] as const) {
        ...
        if (!key) {
          issues.push({
            ...
            node_key: node.node_key,
            field: branch,
            message: `CONDIÇÃO precisa de um nó para o ramo "${branch === "true_next" ? "verdadeiro" : "falso"}".`,
          });
          ...
          issues.push({
            ...
            node_key: node.node_key,
            field: branch,
            message: `Ramo "${branch}" da CONDIÇÃO aponta para nó inexistente "${key}".`,
          });
        }
      }
      break;
    ...
    case "set_tag": {
      ...
      if (!cfg.mode || !["add", "remove"].includes(cfg.mode)) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "mode",
          message: "ADICIONAR ETIQUETA precisa de mode (add ou remove).",
        });
      }
      if (!cfg.tag_id) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "tag_id",
          message: "ADICIONAR ETIQUETA precisa de uma etiqueta para aplicar.",
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: "ADICIONAR ETIQUETA deve apontar para um próximo nó.",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `ADICIONAR ETIQUETA aponta para nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
