...
import { translateDefaultPipelineLabel } from "@/lib/pipelines/default-labels";
...
export default function PipelinesPage() {
  ...
  async function handleCreatePipeline() {
    ...
    if (error || !pipeline) {
      toast.error("Falha ao criar o pipeline");
      setCreating(false);
      return;
    }
          ...
          <DropdownMenu>
            ...
            >
              ...
              <span className="font-semibold">
                {selectedPipeline
                  ? translateDefaultPipelineLabel(selectedPipeline.name)
                  : "Selecionar pipeline"}
              </span>
            ...
            >
              ...
              {pipelines.map((p) => (
                ...
                >
                  ...
                  {translateDefaultPipelineLabel(p.name)}
                </DropdownMenuItem>
              ))}
      ...
      {pipelines.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border py-20">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Crie um pipeline para começar a monitorar oportunidades
          </p>
          <GatedButton
            canAct={canEditSettings}
            gateReason="create pipelines"
