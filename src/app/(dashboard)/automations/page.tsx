...
export default function AutomationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showTemplates && (
        <section>
          <h2 className="mb-3 text-sm font-semibold text-muted-foreground">Modelos para começar</h2>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="text-foreground">{pendingDelete?.name}</span> e seu histórico de execução.
