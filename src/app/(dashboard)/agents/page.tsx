  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        O seu agente de IA com chave própria — configure-o e teste no
        laboratório antes de responder aos clientes na caixa de entrada.
      </p>
        ...
        >
          <TabsList>
            <TabsTrigger value="playground">
              <Sparkles className="mr-1.5 h-4 w-4" /> Laboratório
            </TabsTrigger>
