...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Verifique a URL ou peça para quem convidou enviar um novo link.',
  },
  used: {
  ...
  expired: {
    ...
    body: 'Este convite expirou. Peça ao administrador da conta para enviar outro — leva só alguns segundos para gerar.',
  },
  server_error: {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (res.status === 409) {
          setConflictMessage(
            payload.error ||
              'Você já está em outra conta. Entre com um email diferente para participar desta.',
          );
        } else {
        ...
        <Card className="w-full max-w-md border-border bg-card">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-muted-foreground">
              Ao aceitar, seu acesso será movido para{' '}
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-popover-foreground">
                ...
                Não foi possível entrar em {peek.account_name} com esta conta
              </DialogTitle>
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                saia e cadastre-se novamente com outro endereço de email.
                O link do convite permanece válido enquanto não expirar.
              </p>
            </div>
