  ...
  return (
    <section className="flex h-full flex-col rounded-xl border border-border bg-card">
      ...
      <footer className="flex items-center gap-4 border-t border-border px-5 py-3 text-xs text-muted-foreground">
        <LegendDot color="var(--chart-2)" label="Recebidas" />
  ...
  return (
    <div ref={wrapRef} className="relative w-full">
      ...
      >
        ...
        />
        {/* Incoming polyline (secondary chart accent) */}
        <path
          d={incomingPath}
          fill="none"
          stroke="var(--chart-2)"
      ...
      {hovered && hover !== null && (
        ...
        >
          ...
          <div className="mt-1 flex flex-col gap-0.5">
            <span className="flex items-center gap-1.5 text-[color:var(--chart-2)]">
              <span className="inline-block h-1.5 w-1.5 rounded-full bg-[color:var(--chart-2)]" />
