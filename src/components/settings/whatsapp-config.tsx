...
export function WhatsAppConfig() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (tokenEdited && accessToken !== MASKED_TOKEN && accessToken.trim()) {
        ...
        toast.error('Informe novamente o Access Token para salvar as alterações');
        setSaving(false);
        return;
      }
      ...
      if (data.registered === false && data.registration_error) {
        ...
        toast.success(
          'Credenciais salvas e verificadas. O registro de inbound foi ignorado (sem PIN) — veja o status de registro abaixo.',
          { duration: 10000 },
        );
        setPin('');
      } else {
  ...
  async function handleVerifyRegistration() {
    ...
    try {
      ...
      if (data.live) {
        toast.success('O número está totalmente configurado — o Meta está entregando eventos.');
      } else {
        toast.error(
          'O número não está totalmente registrado. Veja abaixo em qual etapa falhou.',
          { duration: 8000 },
        );
      }
      if (accountId) await fetchConfig(accountId);
  ...
  async function handleReset() {
    if (!confirm('Isso vai excluir a configuração atual do WhatsApp para que você possa informá-la novamente. Continuar?')) {
      return;
    }
    ...
    try {
      ...
      toast.success('Configuração limpa. Agora você pode informar novamente suas credenciais.');
      setConfig(null);
      setPhoneNumberId('');
      setWabaId('');
      setAccessToken('');
    ...
    return (
      <section className="animate-in fade-in-50 duration-200">
        <SettingsPanelHead
          ...
          description="Conecte sua WhatsApp Business API do Meta. Credenciais, webhook e etapas de configuração ficam aqui."
        />
      ...
      <div className="space-y-6">
        ...
        <Alert className="bg-card border-border">
          ...
          <AlertDescription className="text-muted-foreground">
            {connectionStatus === 'connected'
              ? 'Seu Access Token autentica com o Meta. Veja o status de registro abaixo para confirmar se os webhooks estão realmente conectados.'
              : statusMessage ||
                'Configure abaixo suas credenciais da API do Meta para conectar sua conta do WhatsApp Business.'}
          </AlertDescription>
        </Alert>
          ...
          >
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                >
                  {isRegistered
                    ? 'Registered — Meta entregará eventos ao Romeva CRM'
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  . Informe (ou corrija) o PIN de 2 etapas abaixo e clique em
                  Salvar configuração para tentar novamente.
                </>
              ) : (
                <>
                  Este número foi salvo antes de existir o rastreamento
                  de registro, ou o registro foi ignorado. Informe o
                  PIN de 2 etapas abaixo e clique em Salvar configuração para
                  inscrevê-lo.
                </>
              )}
            </AlertDescription>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-foreground">Credenciais de API</CardTitle>
            <CardDescription className="text-muted-foreground">
              Informe suas credenciais da WhatsApp Business API do Meta.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder="Informe seu access token"
                  value={accessToken}
                  onChange={(e) => {
              ...
              {config && !tokenEdited && (
                <p className="text-xs text-muted-foreground">
                  O token fica oculto por segurança. Informe novamente para atualizar a configuração.
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Um texto personalizado criado por você. Deve ser igual ao token definido nas configurações de webhook do Meta.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Necessário apenas para conectar mensagens <strong className="text-muted-foreground">inbound</strong>
                ...
                , depois cole aqui para que o Romeva CRM possa inscrever o número —
                caso contrário, o Meta direciona eventos inbound para o app
                que o reivindicou por último (sintoma que afeta segundos números
                sob uma WABA compartilhada).{' '}
                <strong className="text-muted-foreground">Números de teste do Meta</strong> não têm
                PIN e já vêm pré-registrados — deixe em branco nesses casos.
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Use esta URL como callback do webhook no painel do app no Meta.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
          ...
          <CardContent>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Gere um <strong className="text-foreground">Access Token permanente</strong> em Business Settings &gt; System Users</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Informe o mesmo <strong className="text-foreground">Verify Token</strong> definido aqui</li>
            ...
            <div className="mt-4 pt-4 border-t border-border">
              ...
              >
                ...
                Documentação da API do WhatsApp no Meta
              </a>
            </div>
          </CardContent>
        </Card>
