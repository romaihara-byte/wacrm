...
export function NodeConfigForm({
  ...
  switch (node.node_type) {
        ...
        <>
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">
              Use em mensagens seguintes e na transferência com{" "}
          ...
          <NextNodeRow
            ...
            currentKey={node.node_key}
            onChange={(v) => onUpdateConfig({ next_node_key: v })}
            label="Após coletar, avançar para"
          />
        </>
      );
    ...
    case "handoff":
      return (
        <TextRow
          label="Observação interna (para o atendente que assumirá)"
    ...
    case "end":
      return (
        <p className="text-xs text-muted-foreground">
          Nó terminal. Quando a execução chega aqui, o fluxo é marcado como
          concluído. Nenhuma configuração é necessária.
        </p>
      );
  }
}
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          <label className="text-xs text-muted-foreground">
            Botões (1–3) - cada um leva para um próximo nó diferente
          </label>
        </div>
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <TextRow
          label="Texto do botão de abertura (até 20 caracteres)"
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        <div>
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="var">Variável coletada</SelectItem>
        ...
        <div>
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="absent">Não existe</SelectItem>
          ...
          >
            {uploading ? (
              ...
              <>
                ...
                Clique para enviar (máximo de 16 MB)
              </>
            )}
          </button>
        )}
