...
const contactFields = [
  ...
  { value: 'phone', label: 'Numero de telefone' },
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Mapeie variáveis do modelo para campos do contato, campos personalizados ou
          valores estáticos.
        </p>
      </div>
      ...
      {mediaHeaderType && (
        <div className="rounded-xl border border-border bg-card/50 p-4">
          ...
          <p className="mt-1.5 text-xs text-muted-foreground">
            URL pública da {mediaHeaderType} enviada no cabeçalho da mensagem.
            Usada para todos os destinatários desta campanha.
          </p>
          {mediaHeaderType === 'image' &&
      ...
      <div className="rounded-xl border border-border bg-card/50 p-4">
        <div className="mb-3 flex items-center gap-2">
          ...
          <p className="text-sm font-medium text-foreground">Prévia em tempo real</p>
      ...
      {unmappedKeys.length > 0 && (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs text-amber-300">
          ...
          . Caso contrário, esses placeholders serão enviados para a Meta como strings vazias.
        </div>
      )}
