...
const audienceOptions: {
...
}[] = [
  {
    ...
    description: 'Envie para todos os contatos da sua base',
    icon: Users,
  },
  {
    type: 'tags',
    label: 'Filtrar por etiquetas',
    description: 'Segmente contatos com etiquetas específicas',
    icon: Tags,
  },
  {
    type: 'custom_field',
    label: 'Campo personalizado',
    description: 'Filtre por valor de campo personalizado',
    icon: Filter,
  },
  {
    type: 'csv',
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Escolha quem vai receber esta campanha.
        </p>
      </div>
      ...
      {audience.type === 'tags' && (
        <div className="rounded-xl border border-border bg-card/50 p-4">
          <p className="mb-3 text-sm font-medium text-foreground">Selecione etiquetas</p>
          {loadingTags ? (
      ...
      {audience.type === 'custom_field' && (
        <div className="space-y-3 rounded-xl border border-border bg-card/50 p-4">
          ...
          {loadingFields ? (
            ...
            <p className="text-xs text-muted-foreground">
              Nenhum campo personalizado definido. Crie um em Configurações na seção Campos personalizados.
            </p>
          ) : (
