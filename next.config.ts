...
function buildCspValue(includeUnsafeEval: boolean): string {
  return [
    "default-src 'self'",
    includeUnsafeEval
...
export function getSecurityHeadersForEnv(
  ...
  return [
    ...
    {
      key: cspHeaderName,
      value: buildCspValue(!isProduction),
    },
  ];
}
 ...
 */
const SECURITY_HEADERS = getSecurityHeadersForEnv();
